...
The last column $d_{i}$ counts in how many **documents** each word occurs, one or more times, globally across all documents (also known as the Document Frequency).
